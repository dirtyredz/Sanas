...
_Phased build order. Each phase ends with something you can actually run._
...
**Done when:** you start a meeting _under a job_ and jargon from its glossary transcribes correctly.
