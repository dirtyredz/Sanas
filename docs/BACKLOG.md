...
- [ ] `ipc/`: shape-check object payloads at ingress (job update, glossary add, settings patch) —
      row ids (`requireId`) and free text (`requireText`: search, ask) are validated since 2026-09-09
